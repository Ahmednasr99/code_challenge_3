...
Review.create(star_rating:7 , restaurant_id: shack.id, customer_id: ginger_spice.id)
Review.create(star_rating:8 , restaurant_id: bistro.id, customer_id: scary_spice.id)
Review.create(star_rating:9 , restaurant_id: bistro.id, customer_id: sporty_spice.id)
Review.create(star_rating:4 , restaurant_id: shack.id, customer_id: posh_spice.id)
Review.create(star_rating:8 , restaurant_id: palace.id, customer_id: sporty_spice.id)
Review.create(star_rating:5 , restaurant_id: shack.id, customer_id: posh_spice.id)
Review.create(star_rating:4 , restaurant_id: shack.id, customer_id: posh_spice.id)
